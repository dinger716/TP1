...
public class ViewFirstAdmin {
	...
	// for the user to specify a username for this account (must satisfy FSM requirements) and two copies of the password to be
	...
	private ViewFirstAdmin() {
		...
		// Label to display the Username does not satisfy the FSM requirements
		setupLabelUI(label_UsernameError, "Arial", 18, width, Pos.CENTER, 0, 330);
		...
		theRootPane.getChildren().addAll(label_ApplicationTitle, label_TitleLine1,
				...
				text_AdminPassword2, button_AdminSetup, label_PasswordsDoNotMatch,label_UsernameError,
				button_Quit);
	}
